...
def get_measurements(file, body_height_cm, show = False):
    ...
    if MODE == "KEYPOINTS":
        model = keras.models.load_model('UsizeNetConvolutional_front.h5')    
    ...
    if show:
        ...
        #plt.show()
        plt.savefig("test_images/jara_test_points.jpg")
...
get_measurements("test_images/jara_test_2.jpg", 184, True)
